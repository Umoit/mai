            ...
            <table border="0" style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
              <tr height="50" valign="top">
                ...
                <td>
                    ...
                    <span class="fr">已有商城账号，<a href="{{route('login')}}" style="color:#ff4e00;">我要登录</a></span>
                </td>
              </tr>
              <tr height="50">
                <td align="right"><font color="#ff4e00">*</font>&nbsp;用户名 &nbsp;</td>
                <td><input type="text" value="" name="name" class="l_user" /></td>
              </tr>
              <tr height="50">
              ...
              <tr height="50">
                ...
                <td><input type="password" value="" name="password_confirmation" class="l_pwd" /></td>
              </tr>
              <tr height="50">
              ...
              <tr height="50">
                ...
                <td><input type="text" value="" name="" class="l_tel" /></td>
              </tr>
              <tr height="50">
              ...
              <tr height="50">
                ...
                <td>
                    <input type="text" value="" name="captcha" class="l_ipt" style="vertical-align:middle" />
